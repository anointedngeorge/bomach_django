...
class RealEstate(models.Model):
    ...
    unit_price = MoneyField(max_digits=10, decimal_places=2, default=0.01, default_currency='NGN')
    ...
    legal_fee = MoneyField(max_digits=10, decimal_places=2, default=0.01, default_currency='NGN')
    survey_plan = models.CharField(max_length=500, null=True)
    development_fee = MoneyField(max_digits=10, decimal_places=2, default=0.01, default_currency='NGN')
