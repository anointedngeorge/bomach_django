...
class LandSurveyReport(ReportingSheet):
    ...
    labor_and_bill = models.ForeignKey(to='system_settings.LaborBillQuotation', related_name='land_bills_rel', on_delete=models.CASCADE, null=True)
    material_received = models.ForeignKey(verbose_name='material received and time', to='system_settings.Quotation', related_name='land_survey_rel', on_delete=models.CASCADE, null=True)
    proposed_activity = RichTextField(null=True)
    materials_needed = models.ForeignKey(to='system_settings.Quotation', related_name='land_material_need', on_delete=models.CASCADE, null=True)
    ...
    equipment = models.ForeignKey(to='system_settings.Quotation', 
