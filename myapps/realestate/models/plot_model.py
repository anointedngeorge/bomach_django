...
class RealEstatePlot(models.Model):
    ...
    realestate = models.ForeignKey("realestate.RealEstate", verbose_name=("Realestate"), null=True, on_delete=models.CASCADE, related_name="realestate_rel")
    customer = models.ForeignKey(Customer, null=True, 
    on_delete=models.CASCADE, related_name="customer_realestate_plot_rel")

    name = models.CharField(max_length=500, null=True)
    price = MoneyField(max_digits=10, decimal_places=2, null=True, default_currency='NGN')
