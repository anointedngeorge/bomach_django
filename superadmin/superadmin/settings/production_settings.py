...
import os
from superadmin.jazzime import *
from superadmin.jazzime_ui import *  
from superadmin.ckeditor import *
from superadmin.cronJob import *
from superadmin.celery_config import *
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'superadmin.custom_context_processors.get_system_settings_json',
                'superadmin.context_processor.contextProcessor',
            ],
        },
    },
]
...
ASGI_APPLICATION = 'superadmin.asgi.application'
